...
import os
with open("/tmp/gleich.txt", 'w') as f:
    f.write(t)
    f.close()
  
os.system("zenity --width 800 --height 700 --title 'TV Programm demnächst' --text-info --filename=/tmp/gleich.txt 2>/dev/null")  